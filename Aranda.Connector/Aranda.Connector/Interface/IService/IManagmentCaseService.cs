...
namespace Aranda.Connector.Api.Interface.IService
{
    public interface IManagmentCaseService
    {
        ...
        Task<AnswerCreateCase> Create(InputCreateCaseDto input);
        ...
        Task<AnswerGetCaseApi> Get(InputGetCaseDto input);
        ...
        Task<AnswerCreateCase> Update(InputUpdateCaseDto input);
    }
}